...
//       <div className="tabContent" id="myTabContent">
//         <div className="tabPane fade show active" id="journals" role="tabpanel" aria-labelledby="journals-tab">
//           <div className="row">
//             {getRecordsForCurrentPage().map((journal, index) => (
//               <div className="col-md-4" key={index}>
//                 <div className={styles.popularGenreContent}>
...
//                       <p className="error-message">Error loading image</p>
//                     )}
//                     <p className="d-md-none d-lg-block">{journal.journalTitle}</p>
//                   </div>
//                   <p className={styles.popularGenreDesc}>
//                     {/* {journal.journalTitle}\ */}
//                      {journal.genres}
...
//   return (
//     <section className={`container my-5 ${styles.popularGenreSection}`}>
//       <div className={`${styles.popularGenre} mb-4`}>
//         <h3>Popular by Genre</h3>
//       </div>
...
//                   <p className="error-message">Error loading image</p>
//                 )}
//                 <h4 className="d-md-none d-lg-block">{journal.journalTitle}</h4>
//               </div>
//               <p className={styles.popularGenreDesc}>
//                 {journal.journalTitle} {journal.genres}
//               </p>
//               <p className={styles.popularGenreAuthor}>{journal.editorName}</p>
//             </div>
//           </div>
