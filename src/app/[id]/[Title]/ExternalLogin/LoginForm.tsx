                            ...
                            <div className="auth-form-wrapper px-4 py-5 p-5">
                                ...
                                <form className="forms-sample" onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className="row mb-2 mt-3 d-flex justify-content-center">
                                        ...
                                        <div className="col-md-4 text-center">
                                            {/* 
            Reset Account Feature (Commented Out)
            <button onClick={() => VisitUrl('BookId', 'name', 'RecoverPasswordReset')} className="loginButton">
              Reset Account
            </button> 
          */}
                                        </div>
                                    ...
                                    {/* Additional Buttons (Commented Out in Original) */}
                                    <div className="row mb-2 mt-5">
                                        {/* 
          <div className="col-md-4">
